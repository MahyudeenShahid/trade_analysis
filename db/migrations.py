...
def init_db():
    ...
    try:
        ...
        bot_additions = [
            ...
            ("rule_11_enabled", "INTEGER DEFAULT 0"),
            ("rule_11_price_jump", "REAL DEFAULT 0.03"),
            ("rule_11_window_seconds", "INTEGER DEFAULT 5"),
            ("rule_11_volume_threshold", "INTEGER DEFAULT 5000"),
            ("rule_11_limit_offset", "REAL DEFAULT 0.01"),
