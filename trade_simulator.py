...
from trading.simulator_legacy import LegacyRulesMixin


class TradeSimulator(LegacyRulesMixin):
    ...
    def on_signal(self, trend: str, price_str: Optional[str], ticker: str,
        ...
        if auto:
            ...
            # Default: buy every rise, sell every fall
